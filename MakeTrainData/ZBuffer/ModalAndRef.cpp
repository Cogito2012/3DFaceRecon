...
void MM3D::Cartesian2Ref(double* vertex, double* tri, double* texture, int width, int height, int nver, int ntri, double* ref, double* refco, double* tri_ind)
{
	...
	for(i = 0; i < ntri; i++)
	{
		...
		double cent3d_y = (vertex[3*p1+1] + vertex[3*p2+1] + vertex[3*p3+1]) / 3;
	...
	for(i = 0; i < ntri; i++)
	{
		...
		int u_min = (int)ceil((double)min(min(((double*)pt1.data)[0], ((double*)pt2.data)[0]), ((double*)pt3.data)[0]));
		int u_max = (int)floor((double)max(max(((double*)pt1.data)[0], ((double*)pt2.data)[0]), ((double*)pt3.data)[0]));

		int v_min = (int)ceil((double)min(min(((double*)pt1.data)[1], ((double*)pt2.data)[1]), ((double*)pt3.data)[1]));
		int v_max = (int)floor((double)max(max(((double*)pt1.data)[1], ((double*)pt2.data)[1]), ((double*)pt3.data)[1]));
...
void MM3D::GetCoverTri(double* vertex, double* tri, double* r, double* p, int nver, int ntri, double* coverTri)
{
	...
	for(i = 0; i < ntri; i++)
	{
		...
		double x_min = (double)min(min(((double*)pt1.data)[0], ((double*)pt2.data)[0]), ((double*)pt3.data)[0]);
		double x_max = (double)max(max(((double*)pt1.data)[0], ((double*)pt2.data)[0]), ((double*)pt3.data)[0]);

		double y_min = (double)min(min(((double*)pt1.data)[1], ((double*)pt2.data)[1]), ((double*)pt3.data)[1]);
		double y_max = (double)max(max(((double*)pt1.data)[1], ((double*)pt2.data)[1]), ((double*)pt3.data)[1]);
...
void MM3D::MeshMap(double* vertex, double* tri, int nver, int ntri, double* meshMap, int width, int height)
{
	...
	for(i = 0; i < ntri; i++)
	{
		...
		int x_min = (int)((double)min(min(((double*)pt1.data)[0], ((double*)pt2.data)[0]), ((double*)pt3.data)[0]) + 0.5);
		int x_max = (int)((double)max(max(((double*)pt1.data)[0], ((double*)pt2.data)[0]), ((double*)pt3.data)[0]) + 0.5);

		int y_min = (int)((double)min(min(((double*)pt1.data)[1], ((double*)pt2.data)[1]), ((double*)pt3.data)[1]) + 0.5);
		int y_max = (int)((double)max(max(((double*)pt1.data)[1], ((double*)pt2.data)[1]), ((double*)pt3.data)[1]) + 0.5);
